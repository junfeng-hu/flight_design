...
-- Sun 29 Nov 2015 02:11:26 PM CST
...
-- -----------------------------------------------------
-- Placeholder table for view `flight`.`userflight`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `flight`.`userflight` (`id` INT, `startplace` INT, `starttime` INT, `arrivalplace` INT, `arrivaltime` INT);

-- -----------------------------------------------------
-- View `flight`.`userflight`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `flight`.`userflight`;
USE `flight`;
CREATE  OR REPLACE VIEW `userflight` AS
    SELECT 
        `id`,
        `startplace`,
        `starttime`,
